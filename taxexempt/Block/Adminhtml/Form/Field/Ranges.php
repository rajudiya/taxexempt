...
use Igauri\TaxExempt\Block\Adminhtml\Form\Field\TaxColumn;
use Igauri\TaxExempt\Block\Adminhtml\Form\Field\PaymentMethods;
/**
 * Class Ranges
 */
class Ranges extends AbstractFieldArray
{
    ...
    {
        /*$this->addColumn('from_qty', ['label' => __('Pay Method'), 'class' => 'required-entry']);*/
        $this->addColumn('from_qty', [
            'label' => __('Email Id'),
        ]);
        $this->addColumn('tax', [
            'label' => __('Tex Pay Enable?'),
    ...
    protected function _prepareArrayRow(DataObject $row): void
    {
        ...
        if ($tax !== null) {
            ...
            $options['option_' . $this->getPaymentMethod()->calcOptionHash($tax)] = 'selected="selected"';
        }
